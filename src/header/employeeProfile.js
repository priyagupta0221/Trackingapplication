...
class EmployeeProfile extends Component {
  ...
  componentDidMount() {
    ...
    Auth.getUserData(token).then(response => {
      ...
      if (this.state.userRole == "Admin" || this.state.userRole == "SuperAdmin" || this.state.userRole == "HR") {
      ...
      if (response.status == 200) {
        for (var i = 0; i < response.leaves.length; i++) {
          if (response.leaves[i].requested_by == empId) {
            ...
            updatedPendingLeaves = (pendingLeaves.sort((a, b) => new Date(...a.requested_at.split('-').reverse()) - new Date(...b.requested_at.split('-').reverse()))).reverse();
            var raisedOn = new Date(response.leaves[i].requested_at)
              .toISOString()
              .substring(0, 10);
            var datestring = raisedOn.split("-");
      ...
      if (response.leaves != undefined) {
        ...
        for (var i = 0; i < response.leaves.length; i++) {
          ...
          if ((response.leaves[i].start_date && response.leaves[i].end_date) != undefined) {
            if (
              (response.leaves[i].start_date && response.leaves[i].end_date) != undefined
            ) {
              // var raisedOn = new Date(response.leaves[i].requested_at);
        ...
        updatedApprovedLeaves = (approvedData.sort((a, b) => new Date(...a.requested_at.split('-').reverse()) - new Date(...b.requested_at.split('-').reverse()))).reverse();
        updatedDeclineLeaves = (declinedData.sort((a, b) => new Date(...a.requested_at.split('-').reverse()) - new Date(...b.requested_at.split('-').reverse()))).reverse();
    ...
    if (errors["valid"] == true) {
      Auth.UpdateDetails(
        ...
        if (data.message != "Successfully updated") {
          ...
          setTimeout(() => {
            this.setState({ alertMessage: "Updated successfully", showAlertupdate: false });
          }, 3000);
          // 
          this.componentDidMount();
        }
    ...
    if (errors["valid"] == true) {
      Auth.UpdateDetails(
        ...
        if (data.message != "Successfully updated") {
          ...
          setTimeout(() => {
            this.setState({ alertMessage: "Employee status successfully Changed", showAlertupdate: false });
          }, 3000);
          // 
          this.componentDidMount();
        }
  ...
  render() {
    ...
    if (this.state.loading) {
      ...
      return (
        <div>
          <div className="modal fade update-Emp" id="updateEmp" data-backdrop="static">
          ...
          <div className="modal fade update-Emp" id="updateEmpPermanent" data-backdrop="static">
              ...
              <div className="col-lg-4 col-md-4 pro-leave-info">
                <div className="ibox profile-leave-detail">
                  <div className="ibox-head">
                    ...
                    {this.state.userRole !== "TeamLead" && this.state.userRole !== "Manager" ? (
                      <div>
                        {this.state.emp.empPermanent == 1 ? (
                          <div><button className="btn btn-outline-info  btn-rounded addemployee-btn" data-toggle="modal" data-target="#updateEmpPermanent" aria-pressed="false" onClick={() => this.permanentEmp(empId)}><i class="fa fa-user-plus"></i> Make as Probation</button></div>

                        ) : (
                            ""
                          )}
                        {this.state.emp.empPermanent == 0 ? (
                          <div><button className="btn btn-outline-info  btn-rounded addemployee-btn" data-toggle="modal" data-target="#updateEmpPermanent" aria-pressed="false" onClick={() => this.permanentEmp(empId)}><i class="fa fa-user-plus"></i> Make as Permanent</button></div>

                        ) : (
                            ""
                          )}
                        {this.state.emp.empPermanent == undefined && this.state.emp.teqFocusExp > 0.6 ? (
                          <div><button className="btn btn-outline-info  btn-rounded addemployee-btn" data-toggle="modal" data-target="#updateEmpPermanent" aria-pressed="false" onClick={() => this.permanentEmp(empId)}><i class="fa fa-user-plus"></i> Make as Permanent</button></div>
                  ...
                  <div className="ibox-body">
                    <div className="row">
                      <div className="col-sm-12"><ul className="list-group list-group-full list-group-divider">
                        <li className="list-group-item">Caual Balance:
                        ...
                        {/* <li className="list-group-item">Total Leaves(days) :
                                    <span className="pull-right text-info">{this.state.items.casual_balance + this.state.items.sick_balance}</span>
                                </li> */}
              ...
              <div className="col-lg-8 col-md-8 pro-user-info">
                ...
                <div className="ibox">
                  <div className="ibox-head">
                    ...
                    {this.state.userRole !== "TeamLead" && this.state.userRole !== "Manager" ? (
                      <div><button className="btn btn-outline-info  btn-rounded addemployee-btn" data-toggle="modal" data-target="#updateEmp" aria-pressed="false" onClick={() => this.editEmp(empId)}><i class="fa fa-user-plus"></i> Update Profile</button></div>
                    ) : (
                        ""
                      )}
                      ...
                      <div className="col-lg-6 col-md-6 pro-user-detail">
                        <ul className="list-group list-group-full list-group-divider">
                          ...
                          <li className="list-group-item">Email :
                                    <span className="pull-right ">{this.state.emp.email}</span>
                          </li>
                          {/* <li className="list-group-item">Mobile No :
                                    <span className="pull-right ">1234567890</span>
                                        </li> */}
                          <li className="list-group-item">Role :
                                    <span className="pull-right ">{this.state.emp.role}</span>
                          </li>
                          <li className="list-group-item">Reporting Manager :
                                    <span className="pull-right ">{this.state.emp.report_to}</span>
                          </li>
                          <li className="list-group-item">HR :
                                    <span className="pull-right ">{this.state.emp.hr_name}</span>
                          </li>
                          <li className="list-group-item">Team Lead :
                                    <span className="pull-right ">{this.state.emp.teamlead_name}</span>
                          </li>
                          <li className="list-group-item">Exp In Teq :
                                    <span className="pull-right">{this.state.emp.teqFocusExp}</span>
                          </li>
                          <li className="list-group-item">Total Exp:
                                    <span className="pull-right">{this.state.emp.experience + this.state.emp.teqFocusExp}</span>
                          </li>
                          {this.state.emp.empPermanent == 1 ? (
                            <li className="list-group-item">Empoyee Status :
                              <span className="pull-right">Permanent Employee</span>
                            </li>
                          ) : (
                              ""
                            )}
                          {this.state.emp.empPermanent == 0 ? (
                            <li className="list-group-item">Empoyee Status :
                              <span className="pull-right">Probation Period</span>
                            </li>
                          ) : (
                              ""
                            )}
                          {this.state.emp.empPermanent == 2 ? (
                            <li className="list-group-item">Empoyee Status :
                              <span className="pull-right">Contract Employee</span>
                            </li>
                          ) : (
                              ""
                            )}
                      ...
                      <div className="col-lg-6 col-md-6 pro-img-detail">
                        <div className="text-center">
                          <div className="contentss">
                            ...
                            <div class="font-strong profilename">{this.state.emp.name}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                ...
                <div className="ibox profile-ibox">
                  <div className="ibox-body">
                    <h4 className="text-info m-b-20 m-t-20">
                      <i className="fa fa-tasks"></i> Pending Request
                    </h4>
                    {this.state.showAlert == true ? (
                      <div className="alert alert-success alert-dismissable fade show alertpopup">
                        <button
                          className="close"
                          onClick={this.handleAlert}
                          aria-label="Close"
                      ...
                      <table className="table table-bordered table-hover">
                        ...
                        <tbody>
                          {this.state.dataPerPage.map((item, index) => (
                            <tr key={item._id}>
                              <td>  <td className="tbl-date details">{index + this.state.pending}</td></td>
                              <td><td className="tbl-date details">{item.person_name}</td></td>
                              ...
                              <td><td className="tbl-date details">{item.leave_type != "WFH" ? (item.leave_days) : (item.wfh_days)}</td></td>
                                      ...
                                      <div className="col-md-6">
                                        <div className="customtooltip action col-md-6 approve-thumb">
                                          <button
                                            ...
                                            onClick={() => this.handleShow(item._id, item.leave_type)}
                                            data-toggle="modal"
                                        ...
                                        <div className="customtooltip action col-md-6">
                                          <button
                                            className="btn btn-xs m-r-5"
                                            onClick={() => this.handleShowDecline(item._id, item.leave_type)}
                                            data-toggle="modal"
                                            data-target="#decline"
                                          >
                                      ...
                                      <div className="col-md-6">
                                        {item.message == "Approved By HR" ? (
                                          <div className="float-right">
                                            ...
                                            <button className="btn btn-success hr btn-rounded" data-toggle="modal" disabled={!this.state.adValue}
                                              data-target="#Correction" onClick={() => this.handleShow(item._id)} >
                                              HR
                                </button>
                                          </div>
                                        ) : (
                                              ...
                                              {item.message == "Approved By Delivery Head" ? (
                                                <div className="float-right">
                                                  <button className="btn btn-success tech btn-rounded"
                                                    data-toggle="modal" id="superAdmin" disabled={!this.state.superAdValue}
                                                    data-target="#Correction" onClick={() => this.handleShow(item._id)}>
                                                    Tech
                                    </button>
                                ...
                                : (
                                  <td className="tbl-date">
                                    <div>
                                      {item.message == "Approved By HR" ? (
                                        <div className="float-right">
                                          <button className="btn btn-default tech m-r-20 btn-rounded">
                                            Tech
                                </button>
                                          <button className="btn btn-success hr-mang btn-rounded">
                                            HR
                                          ...
                                          <div>
                                            {item.message == "Approved By Delivery Head" ? (
                                              <div className="float-right">
                                                <button className="btn btn-success tech m-r-20 btn-rounded">
                                                  Tech
                                    </button>
                                                <button className="btn hr-mang btn-default btn-rounded">
                                                  HR
                                                ...
                                                <div className="float-right">
                                                  <button className="btn tech btn-default m-r-20 btn-rounded">
                                                    Tech
                                    </button>
                                                  <button className="btn hr-mang btn-default btn-rounded">
                                                    HR
                    ...
                    <div className="tab-content">
                      <div className="tab-pane fade show active" id="tab-3">
                        ...
                        <div className="mt-page">
                          <Pagination
                            className="justify-content-center"
                            activePage={this.state.activeWfhPageapp}
                            itemsCountPerPage={3}
                            totalItemsCount={100}
                            pageRangeDisplayed={3}
