...
export default class EditableTable extends Component {
  ...
  componentDidMount() {
    ...
    Auth.getUserList().then(response => {
      ...
      // response.users = response.user.slice(0,20)
              ...
              <table className="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <th >Role</th>
                    <th>Location</th>
                    <th className="tbl-date">Casual</th>
                    <th className="tbl-date">Sick </th>
                    <th className="tbl-date">WFH </th>
                  </tr>
                </thead>
                  ...
                  {this.state.userDataList.map((item, index) => (
                    <tr key={item._id}>
                      ...
                      <td className="td tbl-date edit-tbl input td tbl-date 
                        ...
                        <input type="text"
                          ref="casual"
                          value={item.casual_balance}
                          onChange={this.handleCasualBalance(item._id)}
                      ...
                      <td className="td tbl-date edit-tbl input td tbl-date 
                        ...
                        <input type="text"
                          ref="sick"
                          value={item.sick_balance}
                          onChange={this.handleSickBalance(item._id)}
                      ...
                      <td className="td tbl-date edit-tbl input td tbl-date 
                        ...
                        <input type="text"
                          ref="wfh"
                          value={item.wfh_balance}
                          onChange={this.handleWFHbalance(item._id)}
